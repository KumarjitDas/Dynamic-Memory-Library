...
START_TEST(with_only_64_bit) {
    const size_t size = 5;
    uint64_t array1[size] = { 123, 456, 789, 101112, 131415 };
    uint64_t array2[size];
...
START_TEST(with_64_and_32_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint32_t);
    uint8_t array1[size], array2[size];
...
START_TEST(with_64_and_16_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint16_t);
    uint8_t array1[size], array2[size];
...
START_TEST(with_64_and_8_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint8_t);
    uint8_t array1[size], array2[size];
...
START_TEST(with_64_32_and_16_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint32_t) + sizeof(uint16_t);
    uint8_t array1[size], array2[size];
...
START_TEST(with_64_32_and_8_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint32_t) + sizeof(uint8_t);
    uint8_t array1[size], array2[size];
...
START_TEST(with_64_16_and_8_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint16_t) + sizeof(uint8_t);
    uint8_t array1[size], array2[size];
...
START_TEST(with_64_32_16_and_8_bit) {
    const size_t size = sizeof(uint64_t) + sizeof(uint32_t) + sizeof(uint16_t) + sizeof(uint8_t);
    uint8_t array1[size], array2[size];
