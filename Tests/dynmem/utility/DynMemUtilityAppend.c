...
START_TEST(null_memory__minimum_size) {
   ...
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, NULL, 4), DYNMEM_SUCCEED);
...
START_TEST(null_memory__edged_size) {
   ...
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, NULL, 20), DYNMEM_SUCCEED);
   ck_assert_int_eq(dynmem.cs, 40);
   ck_assert_int_eq(dynmem.ei, 16);
   ck_assert_int_eq(DynMemDeallocate(&dynmem), DYNMEM_SUCCEED);
}
...
START_TEST(null_memory__extended_size) {
   ...
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, NULL, 40), DYNMEM_SUCCEED);
...
START_TEST(null_memory__more_extended_size) {
   ...
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, NULL, 80), DYNMEM_SUCCEED);
...
START_TEST(nonnull_memory__minimum_size) {
   ...
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, memory, 4), DYNMEM_SUCCEED);
   ck_assert_int_eq(dynmem.cs, 40);
   ck_assert_int_eq(dynmem.ei, 16);

   uint8_t *temporary_memory = dynmem.m + dynmem.ei + dynmem.es;
...
START_TEST(nonnull_memory__edged_size) {
   ...
   ck_assert_ptr_nonnull(memory);
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, memory, 20), DYNMEM_SUCCEED);
   ck_assert_int_eq(dynmem.cs, 40);
   ck_assert_int_eq(dynmem.ei, 16);
...
START_TEST(nonnull_memory__extended_size) {
   ...
   ck_assert_ptr_nonnull(memory);
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, memory, 40), DYNMEM_SUCCEED);
   ck_assert_int_eq(dynmem.cs, 80);
   ck_assert_int_eq(dynmem.ei, 16);
...
START_TEST(nonnull_memory__more_extended_size) {
   ...
   ck_assert_ptr_nonnull(memory);
   ck_assert_int_eq(DynMemAllocate(&dynmem, 4, 5, NULL), DYNMEM_SUCCEED);
   ck_assert_int_eq(DynMemUtilityAppend(&dynmem, memory, 80), DYNMEM_SUCCEED);
   ck_assert_int_eq(dynmem.cs, 160);
   ck_assert_int_eq(dynmem.ei, 16);
